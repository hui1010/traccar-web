Ext.define("Traccar.view.TouchFix62",{override:"Ext.dom.Element"},function(){var a=this.prototype.additiveEvents,b=this.prototype.eventMap;Ext.supports.TouchEvents&&52<=Ext.firefoxVersion&&Ext.os.is.Desktop&&(b.touchstart="mousedown",b.touchmove="mousemove",b.touchend="mouseup",b.touchcancel="mouseup",b.click="click",b.dblclick="dblclick",a.mousedown="mousedown",a.mousemove="mousemove",a.mouseup="mouseup",a.touchstart="touchstart",a.touchmove="touchmove",a.touchend="touchend",a.touchcancel="touchcancel",
a.pointerdown="mousedown",a.pointermove="mousemove",a.pointerup="mouseup",a.pointercancel="mouseup")});
...
volumeConverter:function(a){return Ext.getStore("VolumeUnits").convertValue(a,Traccar.app.getAttributePreference("volumeUnit"))},hoursFormatter:function(a){return Ext.getStore("HoursUnits").formatValue(a,"h")},hoursConverter:function(a){return Ext.getStore("HoursUnits").convertValue(a,"h")},durationFormatter:function(a){return Ext.getStore("HoursUnits").formatValue(a,"h",!0)},deviceIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllDevices"),0===b.getTotalCount()&&(b=Ext.getStore("Devices")),
(a=b.getById(a))?a.get("name"):""):null},groupIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllGroups"),0===b.getTotalCount()&&(b=Ext.getStore("Groups")),(b=b.getById(a))?b.get("name"):a):null},geofenceIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllGeofences"),0===b.getTotalCount()&&(b=Ext.getStore("Geofences")),(a=b.getById(a))?a.get("name"):""):null},calendarIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllCalendars"),0===b.getTotalCount()&&(b=Ext.getStore("Calendars")),
(a=b.getById(a))?a.get("name"):""):null},driverUniqueIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllDrivers"),0===b.getTotalCount()&&(b=Ext.getStore("Drivers")),(b=b.findRecord("uniqueId",a,0,!1,!0,!0))?a+" ("+b.get("name")+")":a):null},maintenanceIdFormatter:function(a){var b;return 0!==a?(b=Ext.getStore("AllMaintenances"),0===b.getTotalCount()&&(b=Ext.getStore("Maintenances")),(a=b.getById(a))?a.get("name"):""):null},lastUpdateFormatter:function(a){var b;if(a){a=Math.floor((new Date-
a)/1E3);0>a&&(a=0);b=Math.floor(a/86400);if(1<b)return b+" "+Strings.sharedDays;b=Math.floor(a/3600);return 1<b?b+" "+Strings.sharedHours:Math.floor(a/60)+" "+Strings.sharedMinutes}return null},commandTypeFormatter:function(a){var b=Strings["command"+a.charAt(0).toUpperCase()+a.slice(1)];return b?b:a},defaultFormatter:function(a){return"number"===typeof a?Number(a.toFixed(Traccar.Style.numberPrecision)):"boolean"===typeof a?a?Ext.Msg.buttonText.yes:Ext.Msg.buttonText.no:a instanceof Date?Traccar.app.getPreference("twelveHourFormat",
!1)?Ext.Date.format(a,Traccar.Style.dateTimeFormat12):Ext.Date.format(a,Traccar.Style.dateTimeFormat24):a},dateFormatter:function(a){return Ext.Date.format(a,Traccar.Style.dateFormat)},getFormatter:function(a){var b=this;switch(a){case "latitude":case "longitude":return function(c){return b.coordinateFormatter(a,c)};case "speed":return this.speedFormatter;case "course":return this.courseFormatter;case "distance":case "accuracy":return this.distanceFormatter;case "duration":return this.durationFormatter;
case "deviceId":return this.deviceIdFormatter;case "groupId":return this.groupIdFormatter;case "geofenceId":return this.geofenceIdFormatter;case "maintenanceId":return this.maintenanceIdFormatter;case "calendarId":return this.calendarIdFormatter;case "lastUpdate":return this.lastUpdateFormatter;case "spentFuel":return this.volumeFormatter;case "driverUniqueId":return this.driverUniqueIdFormatter;case "commandType":return this.commandTypeFormatter;default:return this.defaultFormatter}},getConverter:function(a){switch(a){case "speed":return this.speedConverter;
case "distance":case "accuracy":return this.distanceConverter;case "spentFuel":return this.volumeConverter;default:return function(a){return a}}},getAttributeFormatter:function(a){switch(Ext.getStore("PositionAttributes").getAttributeDataType(a)){case "distance":return this.distanceFormatter;case "speed":return this.speedFormatter;case "driverUniqueId":return this.driverUniqueIdFormatter;case "voltage":return this.numberFormatterFactory(Traccar.Style.numberPrecision,Strings.sharedVoltAbbreviation);
case "percentage":return this.numberFormatterFactory(Traccar.Style.numberPrecision,"\x26#37;");case "temperature":return this.numberFormatterFactory(Traccar.Style.numberPrecision,"\x26deg;C");case "volume":return this.volumeFormatter;case "hours":return this.hoursFormatter;case "consumption":return this.numberFormatterFactory(Traccar.Style.numberPrecision,Strings.sharedLiterPerHourAbbreviation);default:return this.defaultFormatter}},getAttributeConverter:function(a){switch(Ext.getStore("PositionAttributes").getAttributeDataType(a)){case "distance":return this.distanceConverter;
case "speed":return this.speedConverter;case "volume":return this.volumeConverter;case "hours":return this.hoursConverter;default:return function(a){return a}}},renderAttribute:function(a,b){return b&&"speed"===b.get("dataType")?Ext.getStore("SpeedUnits").formatValue(a,Traccar.app.getAttributePreference("speedUnit","kn"),!0):b&&"distance"===b.get("dataType")?Ext.getStore("DistanceUnits").formatValue(a,Traccar.app.getAttributePreference("distanceUnit","km"),!0):b&&"hours"===b.get("dataType")?Ext.getStore("HoursUnits").formatValue(a,
"h",!0):a}});
...
Ext.define("Traccar.store.ReportRoute",{extend:Ext.data.Store,model:"Traccar.model.Position",proxy:{type:"rest",url:"api/reports/route",timeout:Traccar.Style.reportTimeout,headers:{Accept:"application/json"},listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
Ext.define("Traccar.store.ReportEvents",{extend:Ext.data.Store,model:"Traccar.model.Event",proxy:{type:"rest",url:"api/reports/events",timeout:Traccar.Style.reportTimeout,headers:{Accept:"application/json"},listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
Ext.define("Traccar.store.ReportTrips",{extend:Ext.data.Store,model:"Traccar.model.ReportTrip",proxy:{type:"rest",url:"api/reports/trips",timeout:Traccar.Style.reportTimeout,headers:{Accept:"application/json"},listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
Ext.define("Traccar.store.ReportStops",{extend:Ext.data.Store,model:"Traccar.model.ReportStop",proxy:{type:"rest",url:"api/reports/stops",timeout:Traccar.Style.reportTimeout,headers:{Accept:"application/json"},listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
Ext.define("Traccar.store.ReportSummary",{extend:Ext.data.Store,model:"Traccar.model.ReportSummary",proxy:{type:"rest",url:"api/reports/summary",timeout:Traccar.Style.reportTimeout,headers:{Accept:"application/json"},listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
...
Ext.define("Traccar.store.HoursUnits",{extend:Ext.data.Store,fields:["key","name","fullName"],data:[{key:"h",name:Strings.sharedHourAbbreviation,fullName:Strings.sharedHour}],convertValue:function(a,b,c){return c?36E5*a:a/36E5},formatValue:function(a,b,c){c?(b=Math.floor(a/36E5),a=Math.floor(a%36E5/6E4)):(b=Math.floor(a),a=Math.floor(a%1*60));return b+" "+Strings.sharedHourAbbreviation+" "+a+" "+Strings.sharedMinuteAbbreviation}});
Ext.define("Traccar.model.KnownNotificator",{extend:Ext.data.Model,idProperty:"type",fields:[{name:"type",type:"string"},{name:"name",convert:function(a,b){return Traccar.app.getNotificatorString(b.get("type"))},depends:["type"]}]});Ext.define("Traccar.store.AllNotificators",{extend:Ext.data.Store,model:"Traccar.model.KnownNotificator",proxy:{type:"rest",url:"api/notifications/notificators",listeners:{exception:function(a,b){Traccar.app.showError(b)}}}});
...
(this.units=Ext.create({xtype:"combobox",renderTo:"numberUnitEl",store:"TimeUnits",displayField:"name",valueField:"key",editable:!1,numberField:this,value:"s",width:"70px",listeners:{select:function(){this.numberField.step=this.getStore().convertValue(1,this.getValue(),!0)}}}))};break;case "hours":a.units={},a.units.getStore=function(){return Ext.getStore("HoursUnits")},a.units.getValue=function(){return"h"},b=Strings.sharedHourAbbreviation}a.afterBodyEl=this.unitEl+b+"\x3c/div\x3e\x3c/div\x3e";a.rawToValue=
function(a){return this.units?this.units.getStore().convertValue(this.parseValue(a),this.units.getValue(),!0):this.parseValue(a)};a.valueToRaw=function(a){return this.units?String(this.units.getStore().convertValue(a,this.units.getValue(),!1)):String(a)};a.units&&(a.step=a.units.getStore().convertValue(1,a.units.getValue(),!0))}this.callParent(arguments)}});
Ext.define("Traccar.view.UnescapedTextField",{extend:Ext.form.field.Text,xtype:"unescapedTextField",initComponent:function(){this.callParent();this.on("change",this.onValueChange)},onValueChange:function(a,b){a.setValue(Ext.String.htmlDecode(b))}});
...
b,c;c=Traccar.app.getPreference("deviceReadonly",!1)&&!Traccar.app.getUser().get("administrator");b=Traccar.app.getPreference("readonly",!1)&&!Traccar.app.getUser().get("administrator");this.lookupReference("toolbarAddButton").setDisabled(b||c);this.lookupReference("toolbarDeviceMenu").setHidden(b||c);setInterval(function(){a.getView().getView().refresh()},Traccar.Style.refreshPeriod)},onCommandClick:function(){var a,b,c;a=this.getView().getSelectionModel().getSelection()[0].get("id");b=Ext.create("Traccar.view.dialog.SendCommand");
b.deviceId=a;c=b.lookupReference("commandsComboBox").getStore();c.getProxy().setExtraParam("deviceId",a);Traccar.app.getPreference("limitCommands",!1)||c.add({id:0,description:Strings.sharedNew});c.load({addRecords:!0});c=b.lookupReference("commandType").getStore();c.getProxy().setExtraParam("deviceId",a);c.load();b.show()},updateButtons:function(a){var b,c,d;c=Traccar.app.getPreference("deviceReadonly",!1)&&!Traccar.app.getUser().get("administrator");b=Traccar.app.getPreference("readonly",!1)&&!Traccar.app.getUser().get("administrator");
d=0===a.length;this.lookupReference("toolbarEditButton").setDisabled(d||b||c);this.lookupReference("toolbarRemoveButton").setDisabled(d||b||c);c=this.lookupReference("toolbarDeviceMenu");c.device=d?null:a[0];c.setDisabled(d);this.lookupReference("deviceCommandButton").setDisabled(d||b)},onSelectionChange:function(a,b){b&&b.length&&(this.updateButtons(b),this.fireEvent("selectdevice",b[0],!0))},selectDevice:function(a){this.getView().getSelectionModel().select([a],!1,!0);this.updateButtons(this.getView().getSelectionModel().getSelected().items);
this.getView().getView().focusRow(a)},deselectDevice:function(a){a&&this.deselectFeature()},onUpdateDevice:function(){this.updateButtons(this.getView().getSelectionModel().getSelected().items)},deselectFeature:function(){this.getView().getSelectionModel().deselectAll()}});
Ext.define("Traccar.view.ArrayListFilter",{extend:Ext.grid.filters.filter.List,alias:"grid.filter.arraylist",type:"arraylist",constructor:function(a){this.callParent([a]);this.filter.setFilterFn(function(a){var c,d;c=a.get(this.getProperty());d=this.getValue();if(Ext.isArray(c))for(a=0;a<c.length;a++){if(-1!==d.indexOf(c[a]))return!0}else if(c.match(/[ ,]+/))for(c=c.split(/[ ,]+/).filter(Boolean),a=0;a<c.length;a++){if(-1!==d.indexOf(c[a]))return!0}else if(-1!==d.indexOf(c))return!0;return!1})}});
...
{text:Strings.notificationNotificators,dataIndex:"notificators",flex:2,filter:{type:"arraylist",idField:"type",labelField:"name",store:"AllNotificators"},renderer:function(a){var b="",c;if(a)for(c=a.split(/[ ,]+/).filter(Boolean),a=0;a<c.length;a++)b+=Traccar.app.getNotificatorString(c[a])+(a<c.length-1?", ":"");return b}},{text:Strings.sharedCalendar,dataIndex:"calendarId",flex:1,minWidth:Traccar.Style.columnWidthNormal,hidden:!0,filter:{type:"list",labelField:"name",store:"AllCalendars"},renderer:Traccar.AttributeFormatter.getFormatter("calendarId")}]}});
...
a=a.up("window").down("form");a.updateRecord();b.record=a.getRecord();b.show()}});Ext.define("Traccar.view.UnescapedTextAreaField",{extend:Ext.form.field.TextArea,xtype:"unescapedTextAreaField",initComponent:function(){this.callParent();this.on("change",this.onValueChange)},onValueChange:function(a,b){a.setValue(Ext.String.htmlDecode(b))}});
...
Ext.define("Traccar.view.dialog.DeviceAccumulatorsController",{extend:Ext.app.ViewController,alias:"controller.deviceAccumulators",onSetClick:function(){var a,b={deviceId:this.getView().deviceId};a=this.lookupReference("totalDistance");isNaN(a.getRawValue())||(b.totalDistance=a.getValue());a=this.lookupReference("hours");isNaN(a.getRawValue())||(b.hours=a.getValue());Ext.Ajax.request({scope:this,method:"PUT",url:"api/devices/"+b.deviceId+"/accumulators",jsonData:Ext.util.JSON.encode(b),callback:function(a,
b,e){b||Traccar.app.showError(e)}});this.closeView()}});
...
onDeviceAccumulatorsClick:function(){var a,b=Ext.create("Traccar.view.dialog.DeviceAccumulators");b.deviceId=this.getView().up("deviceMenu").device.getId();if(a=Ext.getStore("LatestPositions").findRecord("deviceId",b.deviceId,0,!1,!1,!0))b.lookupReference("totalDistance").setValue(a.get("attributes").totalDistance),b.lookupReference("hours").setValue(a.get("attributes").hours);b.show()}});
...
0,!1,!1,!0))?(this.position=a,this.updatePosition()):(this.position=null,Ext.getStore("Attributes").removeAll())},selectPosition:function(a){a instanceof Traccar.model.Position&&(this.deviceId=null,this.position=a,this.updatePosition())},deselectFeature:function(){this.position=this.deviceId=null;Ext.getStore("Attributes").removeAll()},clearReport:function(){this.deviceId||(this.position=null,Ext.getStore("Attributes").removeAll())},onGeocode:function(){var a=this.position.getId();this.position.get("address")||
...
0!==this.deviceId.length||this.groupId&&0!==this.groupId.length;c=this.fromDate&&this.fromTime&&this.toDate&&this.toTime;b=!a||!b||!c||this.reportProgress;this.lookupReference("showButton").setDisabled(b);this.lookupReference("exportButton").setDisabled("chart"===a||b);this.lookupReference("emailButton").setDisabled("chart"===a||b)},onReportClick:function(a){var b,c,d,e;this.getGrid().getSelectionModel().deselectAll();(b=this.lookupReference("reportTypeField").getValue())&&(this.deviceId||this.groupId)&&
(c=new Date(this.fromDate.getFullYear(),this.fromDate.getMonth(),this.fromDate.getDate(),this.fromTime.getHours(),this.fromTime.getMinutes(),this.fromTime.getSeconds(),this.fromTime.getMilliseconds()),d=new Date(this.toDate.getFullYear(),this.toDate.getMonth(),this.toDate.getDate(),this.toTime.getHours(),this.toTime.getMinutes(),this.toTime.getSeconds(),this.toTime.getMilliseconds()),e="daily"===b,this.reportProgress=!0,this.updateButtons(),"showButton"===a.reference?("chart"===b?(a=this.getChart().getStore(),
this.getChart().setSeries([])):a=this.getGrid().getStore(),a.showMarkers=this.showMarkers,a.load({scope:this,callback:function(){this.reportProgress=!1;this.updateButtons()},params:{deviceId:this.deviceId,groupId:this.groupId,type:this.eventType,from:c.toISOString(),to:d.toISOString(),daily:e}})):(b=this.getGrid().getStore().getProxy().url,this.excelReport(b,{deviceId:this.deviceId,groupId:this.groupId,type:this.eventType,from:Ext.Date.format(c,"c"),to:Ext.Date.format(d,"c"),daily:e,mail:"emailButton"===
a.reference})))},onClearClick:function(){var a=this.lookupReference("reportTypeField").getValue();this.clearReport(a)},clearReport:function(a){this.getGrid().getStore().removeAll();"trips"!==a&&"events"!==a&&"stops"!==a||Ext.getStore("ReportRoute").removeAll();"chart"===a&&this.getChart().getStore().removeAll()},onSelectionChange:function(a,b){0<b.length&&(a=b[0],this.fireEvent("selectreport",a,!0),a instanceof Traccar.model.ReportTrip&&this.selectTrip(a),(a instanceof Traccar.model.Event||a instanceof
Traccar.model.ReportStop)&&this.selectPositionRelated(a))},selectReport:function(a){var b=this.lookupReference("reportTypeField").getValue();if(a instanceof Traccar.model.Position)if("route"===b)this.getGrid().getSelectionModel().select([a],!1,!0),this.getGrid().getView().focusRow(a);else if("events"===b||"stops"===b)a=this.getGrid().getStore().findRecord("positionId",a.get("id"),0,!1,!0,!0),this.getGrid().getSelectionModel().select([a],!1,!0),this.getGrid().getView().focusRow(a)},deselectReport:function(a){a&&
this.deselectFeature()},deselectFeature:function(){"trips"!==this.lookupReference("reportTypeField").getValue()&&this.getGrid().getSelectionModel().deselectAll()},selectTrip:function(a){var b,c;b=new Date(a.get("startTime"));c=new Date(a.get("endTime"));Ext.getStore("ReportRoute").removeAll();Ext.getStore("ReportRoute").showMarkers=this.showMarkers;Ext.getStore("ReportRoute").load({params:{deviceId:a.get("deviceId"),from:b.toISOString(),to:c.toISOString()}})},selectPositionRelated:function(a){a.get("positionId")&&
(a=Ext.getStore("ReportRoute").getById(a.get("positionId")))&&this.fireEvent("selectreport",a,!0)},loadRelatedPositions:function(a,b){var c,d=[];Ext.getStore("ReportRoute").removeAll();for(a=0;a<b.length;a++)c=b[a],c.get("positionId")&&d.push(c.get("positionId"));0<d.length&&Ext.getStore("Positions").load({params:{id:d},scope:this,callback:function(a,b,c){c&&(Ext.getStore("ReportRoute").showMarkers=this.showMarkers,Ext.getStore("ReportRoute").add(a),1===a.length&&this.fireEvent("selectreport",a[0],
!1))}})},loadRoute:function(a){var b,c,d;if("chart"===this.lookupReference("reportTypeField").getValue()){this.getChart().getAxes()[0].setTitle(Ext.getStore("ReportChartTypes").findRecord("key",this.chartType).get("name"));c=[];b=a.collect("deviceId");for(a=0;a<b.length;a++)d=Ext.create("Ext.data.ChainedStore",{source:"ReportRoute",filters:[{property:"deviceId",value:b[a]}]}),c.push({type:"line",store:d,yField:this.chartType,xField:"fixTime",highlightCfg:{scaling:Traccar.Style.chartMarkerHighlightScaling},
colors:[Traccar.app.getReportColor(b[a])],marker:{type:"circle",radius:Traccar.Style.chartMarkerRadius,fill:Traccar.app.getReportColor(b[a])}});this.getChart().setSeries(c)}},onChartMarkerClick:function(a,b){this.fireEvent("selectreport",b.record,!0)},showSingleEvent:function(a){this.lookupReference("reportTypeField").setValue("events");Ext.getStore("Events").load({id:a,scope:this,callback:function(a,c,d){d&&(Ext.getStore("ReportEvents").add(a),0<a.length&&(a[0].get("positionId")||(Traccar.app.isMobile()?
Traccar.app.showReports(!0):this.getView().expand()),this.getGrid().getSelectionModel().select([a[0]],!1,!0),this.getGrid().getView().focusRow(a[0])))}})},excelReport:function(a,b){Ext.Ajax.request({url:a,method:"GET",timeout:Traccar.Style.reportTimeout,params:b,headers:{Accept:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"},binary:!0,scope:this,callback:function(a,d,e){var f,g;d&&!b.mail&&(a=e.getResponseHeader("Content-Disposition"),a=a.slice(a.indexOf("\x3d")+1,a.length),d=
e.getResponseHeader("Content-Type"),e=new Blob([e.responseBytes],{type:d}),"undefined"!==typeof window.navigator.msSaveBlob?window.navigator.msSaveBlob(e,a):(f=window.URL||window.webkitURL,g=f.createObjectURL(e),a&&Ext.dom.Helper.append(Ext.getBody(),{tag:"a",href:g,download:a}).click(),setTimeout(function(){f.revokeObjectURL(g)},100)));this.reportProgress=!1;this.updateButtons()}})},onTypeChange:function(a,b,c){null!==c&&this.clearReport(c);"route"===b?(this.getGrid().reconfigure("ReportRoute",this.routeColumns),
this.getView().getLayout().setActiveItem("grid")):"events"===b?(this.getGrid().reconfigure("ReportEvents",this.eventsColumns),this.getView().getLayout().setActiveItem("grid")):"summary"===b||"daily"===b?(this.getGrid().reconfigure("ReportSummary",this.summaryColumns),this.getView().getLayout().setActiveItem("grid")):"trips"===b?(this.getGrid().reconfigure("ReportTrips",this.tripsColumns),this.getView().getLayout().setActiveItem("grid")):"stops"===b?(this.getGrid().reconfigure("ReportStops",this.stopsColumns),
this.getView().getLayout().setActiveItem("grid")):"chart"===b&&this.getView().getLayout().setActiveItem("chart");this.updateButtons()},onGeocode:function(a){var b=Ext.getStore("ReportRoute").getById(a);b&&!b.get("address")&&Ext.Ajax.request({scope:this,method:"GET",url:"api/server/geocode",params:{latitude:b.get("latitude"),longitude:b.get("longitude")},success:function(a){b.set("address",a.responseText);b.commit();this.fireEvent("selectReport",b)},failure:function(a){Traccar.app.showError(a)}})},
routeColumns:[{text:Strings.reportDeviceName,dataIndex:"deviceId",renderer:Traccar.AttributeFormatter.getFormatter("deviceId")},{text:Strings.positionValid,dataIndex:"valid",renderer:Traccar.AttributeFormatter.getFormatter("valid")},{text:Strings.positionFixTime,dataIndex:"fixTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.getFormatter("fixTime")},{text:Strings.positionLatitude,dataIndex:"latitude",renderer:Traccar.AttributeFormatter.getFormatter("latitude")},{text:Strings.positionLongitude,
dataIndex:"longitude",renderer:Traccar.AttributeFormatter.getFormatter("longitude")},{text:Strings.positionAltitude,dataIndex:"altitude",renderer:Traccar.AttributeFormatter.getFormatter("altitude")},{text:Strings.positionSpeed,dataIndex:"speed",renderer:Traccar.AttributeFormatter.getFormatter("speed")},{text:Strings.positionAddress,dataIndex:"address",renderer:function(a,b,c){return a?Traccar.AttributeFormatter.getFormatter("address")(a):'\x3ca href\x3d"#" onclick\x3d"Ext.fireEvent(\'routegeocode\', '+
...
{text:Strings.sharedMaintenance,dataIndex:"maintenanceId",renderer:Traccar.AttributeFormatter.getFormatter("maintenanceId")}],summaryColumns:[{text:Strings.reportDeviceName,dataIndex:"deviceId",renderer:Traccar.AttributeFormatter.getFormatter("deviceId")},{text:Strings.reportStartDate,dataIndex:"startTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.dateFormatter},{text:Strings.sharedDistance,dataIndex:"distance",renderer:Traccar.AttributeFormatter.getFormatter("distance")},{text:Strings.reportStartOdometer,
...
{text:Strings.reportSpentFuel,dataIndex:"spentFuel",renderer:Traccar.AttributeFormatter.getFormatter("spentFuel")}],tripsColumns:[{text:Strings.reportDeviceName,dataIndex:"deviceId",renderer:Traccar.AttributeFormatter.getFormatter("deviceId")},{text:Strings.reportStartTime,dataIndex:"startTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.getFormatter("startTime")},{text:Strings.reportStartOdometer,dataIndex:"startOdometer",renderer:Traccar.AttributeFormatter.getFormatter("distance")},{text:Strings.reportStartAddress,
dataIndex:"startAddress",renderer:Traccar.AttributeFormatter.getFormatter("address")},{text:Strings.reportEndTime,dataIndex:"endTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.getFormatter("endTime")},{text:Strings.reportEndOdometer,dataIndex:"endOdometer",renderer:Traccar.AttributeFormatter.getFormatter("distance")},{text:Strings.reportEndAddress,dataIndex:"endAddress",renderer:Traccar.AttributeFormatter.getFormatter("address")},{text:Strings.sharedDistance,dataIndex:"distance",renderer:Traccar.AttributeFormatter.getFormatter("distance")},
...
renderer:Traccar.AttributeFormatter.getFormatter("driverUniqueId")}],stopsColumns:[{text:Strings.reportDeviceName,dataIndex:"deviceId",renderer:Traccar.AttributeFormatter.getFormatter("deviceId")},{text:Strings.reportStartTime,dataIndex:"startTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.getFormatter("startTime")},{text:Strings.positionOdometer,dataIndex:"startOdometer",renderer:Traccar.AttributeFormatter.getFormatter("distance")},{text:Strings.positionAddress,dataIndex:"address",renderer:Traccar.AttributeFormatter.getFormatter("address")},
{text:Strings.reportEndTime,dataIndex:"endTime",xtype:"datecolumn",renderer:Traccar.AttributeFormatter.getFormatter("endTime")},{text:Strings.reportDuration,dataIndex:"duration",renderer:Traccar.AttributeFormatter.getFormatter("duration")},{text:Strings.reportEngineHours,dataIndex:"engineHours",renderer:Traccar.AttributeFormatter.getFormatter("duration")},{text:Strings.reportSpentFuel,dataIndex:"spentFuel",renderer:Traccar.AttributeFormatter.getFormatter("spentFuel")}]});
...
Ext.define("Traccar.view.EventsController",{extend:Ext.app.ViewController,alias:"controller.events",config:{listen:{controller:{"*":{selectdevice:"deselectEvent",selectreport:"deselectEvent"},map:{deselectfeature:"deselectFeature"}},store:{"#Events":{add:"onAddEvent"}}}},init:function(){var a=this;setInterval(function(){a.getView().getView().refresh()},Traccar.Style.refreshPeriod);Traccar.app.isMobile()&&this.lookupReference("hideEventsButton").setHidden(!1)},onRemoveClick:function(){var a;if(a=this.getView().getSelectionModel().getSelection()[0])Ext.getStore("Events").remove(a),
...
Ext.define("Traccar.view.map.BaseMap",{extend:Ext.panel.Panel,xtype:"baseMapView",layout:"fit",getMap:function(){return this.map},getMapView:function(){return this.mapView},initMap:function(){var a,b,c,d,e,f,g=this;a=Traccar.app.getServer();b=Traccar.app.getPreference("map",null);c=a.get("bingKey");switch(b){case "custom":a=new ol.layer.Tile({source:new ol.source.XYZ({url:Ext.String.htmlDecode(a.get("mapUrl")),attributions:""})});break;case "customArcgis":a=new ol.layer.Tile({source:new ol.source.TileArcGISRest({url:Ext.String.htmlDecode(a.get("mapUrl"))})});
break;case "bingRoad":a=new ol.layer.Tile({source:new ol.source.BingMaps({key:c,imagerySet:"Road"})});break;case "bingAerial":a=new ol.layer.Tile({source:new ol.source.BingMaps({key:c,imagerySet:"Aerial"})});break;case "bingHybrid":a=new ol.layer.Tile({source:new ol.source.BingMaps({key:c,imagerySet:"AerialWithLabels"})});break;case "carto":a=new ol.layer.Tile({source:new ol.source.XYZ({url:"https://cartodb-basemaps-{a-d}.global.ssl.fastly.net/light_all/{z}/{x}/{y}.png",attributions:'\x26copy; \x3ca href\x3d"http://www.openstreetmap.org/copyright"\x3eOpenStreetMap\x3c/a\x3e contributors, \x26copy; \x3ca href\x3d"https://carto.com/attributions"\x3eCARTO\x3c/a\x3e'})});
break;case "baidu":a=new ol.layer.Tile({source:new ol.source.XYZ({projection:"BD-MC",tileUrlFunction:function(a){var b=a[0],c=a[1];a=a[2];var d;d=((c<<b)+a)%5;0>c&&(c="M"+-c);0>a&&(a="M"+-a);return"https://online{}.map.bdimg.com/onlinelabel/?qt\x3dtile\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}\x26styles\x3dpl".replace("{}",0>d?d+5:d).replace("{x}",c).replace("{y}",a).replace("{z}",b)},tileGrid:new ol.tilegrid.TileGrid({extent:ol.proj.transformExtent([-180,-74,180,74],"EPSG:4326","BD-MC"),origin:[0,0],minZoom:3,
...
projection:"EPSG:3395",attributions:'\x26copy; \x3ca href\x3d"https://yandex.com/maps/"\x3eYandex\x3c/a\x3e'})});break;case "wikimedia":a=new ol.layer.Tile({source:new ol.source.OSM({url:"https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}.png"})});break;default:a=new ol.layer.Tile({source:new ol.source.OSM({})})}b=Traccar.app.getPreference("latitude",Traccar.Style.mapDefaultLat);c=Traccar.app.getPreference("longitude",Traccar.Style.mapDefaultLon);d=Traccar.app.getPreference("zoom",Traccar.Style.mapDefaultZoom);
...
break;case "nmi":this.map.addControl(new ol.control.ScaleLine({units:"nautical"}));break;default:this.map.addControl(new ol.control.ScaleLine)}f=this.map.getTarget();"string"===typeof f&&(f=Ext.get(f).dom);this.map.on("pointermove",function(a){this.forEachFeatureAtPixel(a.pixel,function(){return!0})?f.style.cursor="pointer":f.style.cursor=""});this.map.on("click",function(a){var b=g.map.getFeaturesAtPixel(a.pixel,{layerFilter:function(a){return!a.get("name")}});if(b)for(a=0;a<b.length;a++)g.fireEvent("selectfeature",
b[a]);else g.fireEvent("deselectfeature")})},listeners:{afterrender:function(){this.initMap()},resize:function(){this.map.updateSize()}}},function(){var a;proj4.defs("BD-MC","+proj\x3dmerc +lon_0\x3d0 +units\x3dm +ellps\x3dclrk66 +no_defs");proj4.defs("EPSG:3395","+proj\x3dmerc +lon_0\x3d0 +k\x3d1 +x_0\x3d0 +y_0\x3d0 +datum\x3dWGS84 +units\x3dm +no_defs");ol.proj.proj4.register(proj4);(a=ol.proj.get("EPSG:3395"))&&a.setExtent([-2.0037508342789244E7,-2.0037508342789244E7,2.0037508342789244E7,2.0037508342789244E7])});
...
c.get("category"))this.updateDeviceMarker(e,this.getDeviceColor(c),c.get("category")),d.changed();c=Ext.String.htmlDecode(c.get("name"));e.getText().getText()!==c&&(e.getText().setText(c),d.changed())}},removeDevice:function(a,b){var c,d;Ext.isArray(b)||(b=[b]);d=this.getView().getMarkersSource();for(a=0;a<b.length;a++)c=b[a].get("id"),this.latestMarkers[c]&&(d.getFeatureById(this.latestMarkers[c].getId())&&d.removeFeature(this.latestMarkers[c]),delete this.latestMarkers[c]),this.accuracyCircles[c]&&
(d.getFeatureById(this.accuracyCircles[c].getId())&&d.removeFeature(this.accuracyCircles[c]),delete this.accuracyCircles[c]),this.liveRoutes[c]&&(d.getFeatureById(this.liveRoutes[c].getId())&&d.removeFeature(this.liveRoutes[c]),delete this.liveRoutes[c])},animateMarker:function(a,b,c){var d,e,f,g,h;d=a.getGeometry().getCoordinates();b=b.getCoordinates();d=new ol.geom.LineString([d,b]);e=Traccar.Style.mapAnimateMarkerDuration;f=Traccar.Style.mapAnimateMarkerTimeout;h=this;g=function(a,b){var c,d;c=
b.get("line").getCoordinateAt(a/(e/f));d=b.getStyle();b.setGeometry(new ol.geom.Point(c));a<e/f?setTimeout(g,f,a+1,b):(d.getImage().angle!==b.get("nextCourse")&&h.rotateMarker(d,b.get("nextCourse")),b.set("animating",!1))};a.set("line",d);a.set("nextCourse",c);a.get("animating")||(a.set("animating",!0),g(1,a))},updateLatest:function(a,b){var c,d,e;Ext.isArray(b)||(b=[b]);e=Ext.getStore("Devices");for(a=0;a<b.length;a++)if(c=b[a],d=e.getById(c.get("deviceId")))this.updateAccuracy(c,d),this.updateLatestMarker(c,
d),this.updateLiveRoute(c,d)},updateAccuracy:function(a,b){var c,d,e;e=this.accuracyCircles[a.get("deviceId")];a.get("accuracy")?(c=ol.proj.fromLonLat([a.get("longitude"),a.get("latitude")]),d=Ext.getStore("DistanceUnits").convertValue(a.get("accuracy"),Traccar.app.getAttributePreference("distanceUnit"),!0),e?(e.getGeometry().setCenter(c),e.getGeometry().setRadius(d)):(e=new ol.Feature(new ol.geom.Circle(c,d)),e.setStyle(this.getAreaStyle(null,Traccar.Style.mapAccuracyColor)),e.setId(a.get("deviceId")),
this.accuracyCircles[a.get("deviceId")]=e,this.isDeviceVisible(b)&&this.getView().getAccuracySource().addFeature(e))):(e&&this.getView().getAccuracySource().getFeatureById(e.getId())&&this.getView().getAccuracySource().removeFeature(e),delete this.accuracyCircles[a.get("deviceId")])},updateLatestMarker:function(a,b){var c,d,e;c=new ol.geom.Point(ol.proj.fromLonLat([a.get("longitude"),a.get("latitude")]));d=a.get("deviceId");d in this.latestMarkers?(e=this.latestMarkers[d],this.animateMarker(e,c,a.get("course"))):
(e=new ol.Feature(c),e.set("record",b),a=this.getLatestMarker(this.getDeviceColor(b),a.get("course"),b.get("category")),a.getText().setText(Ext.String.htmlDecode(b.get("name"))),e.setStyle(a),e.setId(b.get("id")),this.latestMarkers[d]=e,this.isDeviceVisible(b)&&this.getView().getMarkersSource().addFeature(e));e===this.selectedMarker&&this.lookupReference("deviceFollowButton").pressed&&this.getView().getMapView().setCenter(e.getGeometry().getCoordinates())},updateLiveRoute:function(a,b){var c,d;c=
a.get("deviceId");if(c in this.liveRoutes){if(b=this.liveRoutes[c].getGeometry().getCoordinates(),d=b[b.length-1],a=ol.proj.fromLonLat([a.get("longitude"),a.get("latitude")]),d[0]!==a[0]||d[1]!==a[1])b.length>=this.liveRouteLength&&b.shift(),b.push(a),this.liveRoutes[c].getGeometry().setCoordinates(b)}else a=new ol.Feature({geometry:new ol.geom.LineString([ol.proj.fromLonLat([a.get("longitude"),a.get("latitude")])])}),a.setStyle(this.getRouteStyle(c)),a.setId(c),this.liveRoutes[c]=a,this.isDeviceVisible(b)&&
...
this.getView().getMarkersSource().removeFeature(this.selectedMarker):!Ext.getStore("ReportRoute").showMarkers&&this.selectedMarker.get("record")instanceof Traccar.model.Position?(this.getView().getMarkersSource().removeFeature(this.selectedMarker),delete this.reportMarkers[this.selectedMarker.get("record").get("id")]):(this.resizeMarker(this.selectedMarker.getStyle(),!1),this.selectedMarker.getStyle().setZIndex(0),this.selectedMarker.changed()));a&&(this.resizeMarker(a.getStyle(),!0),a.getStyle().setZIndex(1),
a.changed(),b&&(this.getView().getMapView().setCenter(a.getGeometry().getCoordinates()),0!==this.selectZoom&&this.selectZoom>this.getView().getMapView().getZoom()&&this.getView().getMapView().setZoom(this.selectZoom)));this.selectedMarker=a},selectDevice:function(a,b){this.selectMarker(this.latestMarkers[a.get("id")],b)},selectReport:function(a,b){a instanceof Traccar.model.Position?(Ext.getStore("ReportRoute").showMarkers||(this.reportMarkers[a.get("id")]=this.addReportMarker(a)),this.selectMarker(this.reportMarkers[a.get("id")],
b)):this.selectedMarker&&this.selectMarker(null,!1)},selectEvent:function(a){a?(a=this.addReportMarker(a),a.set("event",!0),this.selectMarker(a,!0)):this.selectedMarker&&this.selectedMarker.get("event")&&this.selectMarker(null,!1)},selectFeature:function(a){(a=a.get("record"))&&(a instanceof Traccar.model.Device?this.fireEvent("selectdevice",a,!1):this.fireEvent("selectreport",a,!1))},deselectFeature:function(){this.deselectDevice();this.fireEvent("deselectfeature")},deselectDevice:function(){this.selectMarker(null,
!1)},zoomToAllPositions:function(a){var b,c,d,e,f,g;for(b=0;b<a.length;b++)c=ol.proj.fromLonLat([a[b].get("longitude"),a[b].get("latitude")]),0===b?(d=f=c[0],e=g=c[1]):(d=Math.min(c[0],d),e=Math.min(c[1],e),f=Math.max(c[0],f),g=Math.max(c[1],g));d!==f||e!==g?this.getView().getMapView().fit([d,e,f,g]):c&&this.getView().getMapView().fit(new ol.geom.Point(c))},updateVisibleDevices:function(a,b){var c;Ext.isArray(b)||(b=[b]);for(a=0;a<b.length;a++)c=b[a],c.get("id")in this.latestMarkers&&this.updateDeviceVisibility(c)},
isDeviceVisible:function(a){return Ext.getStore("VisibleDevices").contains(a)},updateDeviceVisibility:function(a){var b,c,d;b=a.get("id");d=this.latestMarkers[b];c=this.accuracyCircles[b];b=this.liveRoutes[b];this.isDeviceVisible(a)?(d&&!this.getView().getMarkersSource().getFeatureById(d.getId())&&this.getView().getMarkersSource().addFeature(d),c&&!this.getView().getAccuracySource().getFeatureById(c.getId())&&this.getView().getAccuracySource().addFeature(c),b&&!this.getView().getLiveRouteSource().getFeatureById(b.getId())&&
this.getView().getLiveRouteSource().addFeature(b)):(d&&this.getView().getMarkersSource().getFeatureById(d.getId())&&this.getView().getMarkersSource().removeFeature(d),c&&this.getView().getAccuracySource().getFeatureById(c.getId())&&this.getView().getAccuracySource().removeFeature(c),b&&this.getView().getLiveRouteSource().getFeatureById(b.getId())&&this.getView().getLiveRouteSource().removeFeature(b))},filterDevices:function(){Ext.getStore("Devices").each(this.updateDeviceVisibility,this,!1)}});
...
Number(b[0])],"EPSG:4326",c),a=a.getResolution(),c=ol.proj.getPointResolution(c,a,d),b=Number(b[2])/ol.proj.Units.METERS_PER_UNIT.m*(a/c),c=new ol.geom.Circle(d,b)));else if(0===b.lastIndexOf("LINESTRING",0)&&(b=b.match(/\([^()]+\)/),null!==b&&(b=b[0].match(/-?\d+\.?\d*/g),null!==b))){c=a.getProjection();for(a=0;a<b.length;a+=2)e=Number(b[a]),f=Number(b[a+1]),d.push(ol.proj.transform([f,e],"EPSG:4326",c));c=new ol.geom.LineString(d)}return c},geometryToWkt:function(a,b){var c;if(b instanceof ol.geom.Circle)c=
b.getCenter(),b=b.getRadius(),b=[c[0]+b,c[1]],c=ol.proj.transform(c,a,"EPSG:4326"),a=ol.sphere.getDistance(c,ol.proj.transform(b,a,"EPSG:4326"),6378137),c="CIRCLE ("+(c[1]+" "+c[0]+", "),c+=a.toFixed(1)+")";else if(b instanceof ol.geom.Polygon){b.transform(a,"EPSG:4326");b=b.getCoordinates();c="POLYGON((";for(a=0;a<b[0].length;a+=1)c+=b[0][a][1]+" "+b[0][a][0]+", ";c=c.substring(0,c.length-2)+"))"}else if(b instanceof ol.geom.LineString){b.transform(a,"EPSG:4326");b=b.getCoordinates();c="LINESTRING (";
for(a=0;a<b.length;a+=1)c+=b[a][1]+" "+b[a][0]+", ";c=c.substring(0,c.length-2)+")"}return c}});
...
{title:Strings.sharedMaintenance,items:{xtype:"linkMaintenancesView",baseObjectName:"userId",linkObjectName:"maintenanceId",storeName:"AllMaintenances",linkStoreName:"Maintenances",baseObject:a.getId()}}).show()},onSelectionChange:function(a,b){var c=0===b.length;this.lookupReference("userDevicesButton").setDisabled(c);this.lookupReference("userGroupsButton").setDisabled(c);this.lookupReference("userGeofencesButton").setDisabled(c);this.lookupReference("userNotificationsButton").setDisabled(c);this.lookupReference("userCalendarsButton").setDisabled(c);
...
Ext.define("Traccar.view.map.GeofenceMapController",{extend:Ext.app.ViewController,alias:"controller.geofenceMap",config:{listen:{controller:{"*":{mapstate:"setMapState"}}}},onFileChange:function(a){var b,c=this.getView();0<a.fileInputEl.dom.files.length&&(b=new FileReader,b.onload=function(){var a,e,f=[];a=(new DOMParser).parseFromString(b.result,"text/xml").getElementsByTagName("trkseg")[0];e=c.mapView.getProjection();Array.from(a.getElementsByTagName("trkpt")).forEach(function(a){var b;b=Number(a.getAttribute("lat"));
a=Number(a.getAttribute("lon"));f.push(ol.proj.transform([a,b],"EPSG:4326",e))});c.getFeatures().clear();c.getFeatures().push(new ol.Feature(new ol.geom.LineString(f)))},b.onerror=function(a){Traccar.app.showError(a.target.error)},b.readAsText(a.fileInputEl.dom.files[0]))},onSaveClick:function(a){var b,c;0<this.getView().getFeatures().getLength()&&(b=this.getView().getFeatures().pop().getGeometry(),c=this.getView().getMapView().getProjection(),this.fireEvent("savearea",Traccar.GeofenceConverter.geometryToWkt(c,
b)),a.up("window").close())},onCancelClick:function(a){a.up("window").close()},onTypeSelect:function(a){this.getView().removeInteraction();this.getView().addInteraction(a.getValue())},setMapState:function(a,b,c){this.getView().getMapView().setCenter(ol.proj.fromLonLat([b,a]));this.getView().getMapView().setZoom(c)}});
Ext.define("Traccar.view.map.GeofenceMap",{extend:Traccar.view.map.BaseMap,xtype:"geofenceMapView",controller:"geofenceMap",bodyBorder:!0,tbar:{items:[{xtype:"combobox",store:"GeofenceTypes",valueField:"key",displayField:"name",editable:!1,listeners:{select:"onTypeSelect"}},"-",{xtype:"tbtext",html:Strings.sharedImport},{xtype:"filefield",name:"file",buttonConfig:{glyph:"xf093@FontAwesome",text:"",tooltip:Strings.sharedSelectFile,tooltipType:"title"},listeners:{change:"onFileChange",afterrender:function(a){a.fileInputEl.set({accept:".gpx"})}}},
...
this.controller.fireEvent("mapstaterequest");b=ol.color.asArray(Traccar.Style.mapGeofenceColor);b[3]=Traccar.Style.mapGeofenceOverlayOpacity;(new ol.layer.Vector({source:new ol.source.Vector({features:this.features}),style:new ol.style.Style({fill:new ol.style.Fill({color:b}),stroke:new ol.style.Stroke({color:Traccar.Style.mapGeofenceColor,width:Traccar.Style.mapGeofenceWidth}),image:new ol.style.Circle({radius:Traccar.Style.mapGeofenceRadius,fill:new ol.style.Fill({color:Traccar.Style.mapGeofenceColor})})})})).setMap(a);
a.addInteraction(new ol.interaction.Modify({features:this.features,deleteCondition:function(a){return ol.events.condition.shiftKeyOnly(a)&&ol.events.condition.singleClick(a)}}))},addInteraction:function(a){var b=this;this.draw=new ol.interaction.Draw({features:this.features,type:a});this.draw.on("drawstart",function(){b.features.clear()});this.map.addInteraction(this.draw)},removeInteraction:function(){this.draw&&(this.map.removeInteraction(this.draw),this.draw=null)}});
...
Ext.define("Traccar.view.dialog.NotificationController",{extend:Traccar.view.dialog.BaseEditController,alias:"controller.notification",init:function(){this.lookupReference("calendarCombo").setHidden(Traccar.app.getBooleanAttributePreference("ui.disableCalendars"))},onTypeChange:function(a,b){this.lookupReference("alarmsField").setHidden("alarm"!==b)},onAlarmsLoad:function(a){var b;b=a.up("form").getRecord().get("attributes")||{};b.alarms&&(a.suspendEvents(!1),a.setValue(b.alarms.split(",")),a.resumeEvents())},
onAlarmsChange:function(a,b){var c=a.up("window").down("form").getRecord();a=c.get("attributes")||{};b=b.join();a.alarms!==b&&(a.alarms=b,c.set("attributes",a),c.dirty=!0)}});
...
dataIndex:"always",renderer:Traccar.AttributeFormatter.getFormatter("always"),filter:"boolean"},{text:Strings.sharedAlarms,dataIndex:"attributes",renderer:function(a){var b,c="",d=a&&a.alarms;if(d)for(d=d.split(","),a=0;a<d.length;a++)b="alarm"+d[a].charAt(0).toUpperCase()+d[a].slice(1),c&&(c+=", "),c+=Strings[b]||b;return c}},{text:Strings.notificationNotificators,dataIndex:"notificators",flex:2,filter:{type:"arraylist",idField:"type",labelField:"name",store:"AllNotificators"},renderer:function(a){var b=
"",c;if(a)for(c=a.split(/[ ,]+/).filter(Boolean),a=0;a<c.length;a++)b+=Traccar.app.getNotificatorString(c[a])+(a<c.length-1?", ":"");return b}},{text:Strings.sharedCalendar,dataIndex:"calendarId",hidden:!0,filter:{type:"list",labelField:"name",store:"AllCalendars"},renderer:Traccar.AttributeFormatter.getFormatter("calendarId")}]}});
...
store:"MaintenanceTypes",listeners:{change:"onNameChange"}},{xtype:"customNumberField",name:"start",reference:"startField",fieldLabel:Strings.maintenanceStart},{xtype:"customNumberField",name:"period",reference:"periodField",allowBlank:!1,fieldLabel:Strings.maintenancePeriod,validator:function(a){return 0!==this.parseValue(a)?!0:Strings.errorZero}}]}]}});
...
Ext.define("Traccar.view.SettingsMenuController",{extend:Ext.app.ViewController,alias:"controller.settings",init:function(){var a,b,c;a=Traccar.app.getUser().get("administrator");b=0!==Traccar.app.getUser().get("userLimit");c=Traccar.app.getPreference("readonly",!1);a&&(this.lookupReference("settingsServerButton").setHidden(!1),this.lookupReference("settingsStatisticsButton").setHidden(!1),this.lookupReference("settingsComputedAttributesButton").setHidden(Traccar.app.getBooleanAttributePreference("ui.disableComputedAttributes")));
...
Ext.define("Traccar.view.Main",{extend:Ext.container.Viewport,alias:"widget.main",controller:"mainController",layout:"border",defaults:{header:!1,collapsible:!0,split:{size:5}},items:[{region:"west",layout:"border",width:Traccar.Style.deviceWidth,title:Strings.devicesAndState,titleCollapse:!0,floatable:!1,stateful:!0,stateId:"devices-and-state-panel",defaults:{split:{size:5},flex:1},items:[{region:"center",xtype:"devicesView"},{region:"south",xtype:"stateView"}]},{region:"south",xtype:"reportView",
reference:"reportView",height:Traccar.Style.reportHeight,collapsed:!0,titleCollapse:!0,floatable:!1},{region:"center",xtype:"mapView",collapsible:!1},{region:"east",xtype:"eventsView",reference:"eventsView",width:Traccar.Style.deviceWidth,collapsed:!0,titleCollapse:!0,floatable:!1}]});
...
(d.add({key:"attribute."+c.get("key"),name:c.get("name")}),e.add(c))},calculateAttribute:function(a){a=a.attributes[this.attributeKey];return void 0!==a?Traccar.AttributeFormatter.getAttributeConverter(this.attributeKey)(a):a},onLaunch:function(){Ext.Ajax.request({scope:this,url:"api/server",callback:this.onServerReturn})},showAnnouncement:function(a){var b=Ext.getBody().getViewSize().width-2*Traccar.Style.normalPadding;b>Traccar.Style.windowWidth&&(b=Traccar.Style.windowWidth);Ext.Msg.show({msg:a,
buttons:Ext.Msg.OK,closable:!1,modal:!1,maxWidth:b}).alignTo(Ext.getBody(),"t-t",[0,Traccar.Style.normalPadding])},onServerReturn:function(a,b,c){a={};if(b){Traccar.app.setServer(Ext.decode(c.responseText));(b=Traccar.app.getServer().get("announcement"))&&this.showAnnouncement(b);if(b=Ext.Object.fromQueryString(window.location.search).token)a.token=b;Ext.Ajax.request({scope:this,url:"api/session",method:"GET",params:a,callback:this.onSessionReturn})}else Traccar.app.showError(c)},onSessionReturn:function(a,
b,c){Ext.get("spinner").setVisible(!1);b?(Traccar.app.setUser(Ext.decode(c.responseText)),this.loadApp()):(this.login=Ext.create("widget.login",{listeners:{scope:this,login:this.onLogin}}),this.login.show())},onLogin:function(){this.login.close();this.loadApp()},loadApp:function(){var a;window.webkit&&window.webkit.messageHandlers.appInterface&&window.webkit.messageHandlers.appInterface.postMessage("login");window.appInterface&&window.appInterface.postMessage("login");Ext.getStore("Groups").load();
Ext.getStore("Drivers").load();Ext.getStore("Geofences").load();Ext.getStore("Calendars").load();Ext.getStore("Maintenances").load();Ext.getStore("ComputedAttributes").load();Ext.getStore("AllCommandTypes").load();Ext.getStore("Commands").load();Ext.getStore("AllNotificationTypes").load({callback:function(a,c,d){c=Ext.getStore("ReportEventTypes");d&&(c.add({type:Traccar.store.ReportEventTypes.allEvents,name:Strings.eventAll}),c.loadData(a,!0))}});Ext.getStore("AllNotificators").load();Ext.getStore("Notifications").load();
Ext.getStore("ServerAttributes").loadData(Ext.getStore("CommonDeviceAttributes").getData().items,!0);Ext.getStore("ServerAttributes").loadData(Ext.getStore("CommonUserAttributes").getData().items,!0);Ext.getStore("UserAttributes").loadData(Ext.getStore("CommonUserAttributes").getData().items,!0);Ext.getStore("DeviceAttributes").loadData(Ext.getStore("CommonDeviceAttributes").getData().items,!0);Ext.getStore("GroupAttributes").loadData(Ext.getStore("CommonDeviceAttributes").getData().items,!0);Ext.getStore("Devices").load({scope:this,
callback:function(){this.asyncUpdate(!0)}});(a=Ext.get("update"))&&a.remove();(a=Ext.get("attribution"))&&a.remove();Traccar.app.isMobile()?Ext.create("widget.mainMobile"):Ext.create("widget.main");if(a=Ext.Object.fromQueryString(window.location.search).eventId)this.fireEvent("showsingleevent",a),this.removeUrlParameter("eventId")},beep:function(){this.beepSound||(this.beepSound=new Audio("beep.wav"));this.beepSound.play()},soundPressed:function(){var a=Ext.getCmp("soundButton");return a&&a.pressed},
removeUrlParameter:function(a){var b=Ext.Object.fromQueryString(window.location.search);delete b[a];Ext.Object.isEmpty(b)?window.history.pushState(null,null,window.location.pathname):window.history.pushState(null,null,window.location.pathname+"?"+Ext.Object.toQueryString(b))},asyncUpdate:function(a){var b=this,c,d;c="https:"===window.location.protocol?"wss:":"ws:";d=window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1);c=new WebSocket(c+"//"+window.location.host+d+"api/socket");
c.onclose=function(){Traccar.app.showToast(Strings.errorSocket,Strings.errorTitle);Ext.Ajax.request({url:"api/devices",success:function(a){b.updateDevices(Ext.decode(a.responseText))},failure:function(a){401===a.status&&window.location.reload()}});Ext.Ajax.request({url:"api/positions",headers:{Accept:"application/json"},success:function(a){b.updatePositions(Ext.decode(a.responseText))}});setTimeout(function(){b.asyncUpdate(!1)},Traccar.Style.reconnectTimeout)};c.onmessage=function(c){c=Ext.decode(c.data);
c.devices&&b.updateDevices(c.devices);c.positions&&(b.updatePositions(c.positions,a),a=!1);c.events&&b.updateEvents(c.events)}},updateDevices:function(a){var b,c,d;c=Ext.getStore("Devices");for(b=0;b<a.length;b++)(d=c.getById(a[b].id))&&d.set({status:a[b].status,lastUpdate:a[b].lastUpdate,geofenceIds:a[b].geofenceIds},{dirty:!1})},updatePositions:function(a,b){var c,d,e,f;d=Ext.getStore("LatestPositions");for(c=0;c<a.length;c++)(e=d.findRecord("deviceId",a[c].deviceId,0,!1,!1,!0))?e.set(a[c]):d.add(Ext.create("Traccar.model.Position",
a[c])),Ext.getStore("Events").findRecord("positionId",a[c].id,0,!1,!1,!0)&&Ext.getStore("EventPositions").add(Ext.create("Traccar.model.Position",a[c]));b&&((a=Ext.Object.fromQueryString(window.location.search).deviceId)&&(f=Ext.getStore("VisibleDevices").findRecord("id",a,0,!1,!0,!0))&&this.fireEvent("selectdevice",f,!0),f||this.zoomToAllDevices())},updateEvents:function(a){var b,c,d;c=Ext.getStore("Events");for(b=0;b<a.length;b++)c.insert(0,a[b]),(d=Ext.getStore("Devices").getById(a[b].deviceId))?
(this.soundPressed()&&this.beep(),Traccar.app.showToast(a[b].text,d.get("name"))):Traccar.app.showToast(a[b].text)},zoomToAllDevices:function(){var a,b,c;a=Traccar.app.getPreference("latitude",0);b=Traccar.app.getPreference("longitude",0);c=Traccar.app.getPreference("zoom",0);0===a&&0===b&&0===c&&this.fireEvent("zoomtoalldevices")}});
...
controllers:["Root"],isMobile:function(){return window.matchMedia&&window.matchMedia("(max-width: 768px)").matches},getVehicleFeaturesDisabled:function(){return this.getBooleanAttributePreference("ui.disableVehicleFetures")},getEventString:function(a){a="event"+a.charAt(0).toUpperCase()+a.slice(1);return Strings[a]||a},getNotificatorString:function(a){a="notificator"+a.charAt(0).toUpperCase()+a.slice(1);return Strings[a]||a},showReports:function(a){var b=Ext.getCmp("rootPanel");b&&b.setActiveItem(a?
1:0)},showEvents:function(a){var b=Ext.getCmp("rootPanel");b&&b.setActiveItem(a?2:0)},updateNotificationToken:function(a){var b=Ext.clone(this.user.get("attributes"));if(!b.notificationTokens||0>b.notificationTokens.indexOf(a))b.notificationTokens=b.notificationTokens?b.notificationTokens+(","+a):a,this.user.set("attributes",b),this.user.save()},setUser:function(a){this.user=Ext.create("Ext.data.reader.Json",{model:"Traccar.model.User"}).readRecords(a).getRecords()[0]},getUser:function(){return this.user},
setServer:function(a){this.server=Ext.create("Ext.data.reader.Json",{model:"Traccar.model.Server"}).readRecords(a).getRecords()[0]},getServer:function(){return this.server},getPreference:function(a,b){return this.getServer().get("forceSettings")?this.getServer().get(a)||this.getUser().get(a)||b:this.getUser().get(a)||this.getServer().get(a)||b},getAttributePreference:function(a,b){return this.getServer().get("forceSettings")?this.getServer().get("attributes")[a]||this.getUser().get("attributes")[a]||
b:this.getUser().get("attributes")[a]||this.getServer().get("attributes")[a]||b},getBooleanAttributePreference:function(a){return"true"===this.getAttributePreference(a,!1).toString()},getReportColor:function(a){var b,c=Ext.getStore("Devices").getById(a);c&&(b=c.get("attributes")["web.reportColor"]);if(b)return b;b=0;void 0!==a&&(b=a%Traccar.Style.mapRouteColor.length);return Traccar.Style.mapRouteColor[b]},showError:function(a){Ext.isString(a)?Ext.Msg.alert(Strings.errorTitle,a):a.responseText?Ext.Msg.alert(Strings.errorTitle,
Strings.errorGeneral+'\x3cbr\x3e\x3cbr\x3e\x3ctextarea readonly rows\x3d"5" style\x3d"resize: none; width: 100%;"\x3e'+a.responseText+"\x3c/textarea\x3e"):a.statusText?Ext.Msg.alert(Strings.errorTitle,a.statusText):Ext.Msg.alert(Strings.errorTitle,Strings.errorConnection)},showToast:function(a,b){Ext.toast({html:a,title:b,width:Traccar.Style.toastWidth,align:"br"})}});Ext.application({name:"Traccar",extend:Traccar.Application});